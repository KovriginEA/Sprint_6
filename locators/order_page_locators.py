...
class OrderPageLocators:
    ...
    input_lastname = (By.XPATH, "//input[contains(@placeholder,'* Фамилия')]")
    input_address = (By.XPATH, "//input[contains(@placeholder,'* Адрес: куда привезти заказ')]")
    ...
    input_comments = (By.XPATH, "//input[contains(@placeholder,'Комментарий для курьера')]")
